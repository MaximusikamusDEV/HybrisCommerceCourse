...
public class ProductWarrantyValueResolver extends AbstractValueResolver<ProductModel, Integer, Object> {
    @Override
    protected Integer loadData(IndexerBatchContext batchContext,
                               Collection<IndexedProperty> indexedProperties,
                               ProductModel model){
        return Optional.ofNullable(model.getWarrantyYears()).orElse(0);
    }
    ...
    protected void addFieldValues(InputDocument inputDocument,
        ...
        int warrantyYears = valueResolverContext.getData();
